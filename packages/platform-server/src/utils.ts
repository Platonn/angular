...
/**
 * Destroys the application in a macrotask, this allows pending promises to be settled and errors
 * to be surfaced to the users.
 */
function asyncDestroyPlatformRef(platformRef: PlatformRef): Promise<void> {
...
export async function renderModule<T>(
  ...
  try {
    ...
    await asyncDestroyPlatformRef(platformRef);
  }
}
